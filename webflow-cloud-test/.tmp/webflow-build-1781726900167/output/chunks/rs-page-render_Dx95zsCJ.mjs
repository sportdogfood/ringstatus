...
function renderBaseStyle() {
  return [
    ...
    `@media(max-width:700px){.rs-main{padding:14px 16px}.rs-main .rs-nav-inner{align-items:center}.rs-nav-logo{font-size:24px}.rs-nav-links{justify-content:flex-start}.rs-main .rs-nav-link{flex:0 0 auto}.rs-content-flex{display:flex;flex-direction:column;align-items:stretch;gap:20px}.rs-visual{width:100%;flex:auto;aspect-ratio:16/10;min-height:0}}`,
    `</style>`
  ].join("");
}
