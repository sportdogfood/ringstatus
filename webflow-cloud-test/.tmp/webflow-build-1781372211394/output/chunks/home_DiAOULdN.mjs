...
import { a as airtableConfig, j as json, p as planReport, c as corsHeaders } from "./wec-plan-modules_hXO0hoAk.mjs";
import { h as horseKitReport } from "./wec-horse-kits_Dx5nL3ge.mjs";
const config = {
  runtime: "edge"
};
