...
const LOADER_JS = String.raw`(function () {
  ...
  function boot() {
    ...
    document.addEventListener("click", function (event) {
      var megaTrigger = event.target && event.target.closest ? event.target.closest(".rs-main [data-rs-mega-trigger]") : null;
      ...
      var drawerTrigger = event.target && event.target.closest ? event.target.closest(".rs-main [data-rs-drawer-trigger]") : null;
      ...
      var drawerClose = event.target && event.target.closest ? event.target.closest(".rs-main [data-rs-drawer-close],.rs-main .rs-nav-scrim") : null;
      ...
      var link = event.target && event.target.closest ? event.target.closest(".rs-main .rs-nav-link[data-rs-page-key],.rs-main .rs-mega-link[data-rs-page-key],.rs-main .rs-drawer-list a[data-rs-page-key],.rs-main .rs-logo[data-rs-page-key]") : null;
  ...
  function collectNavKeys(root) {
    var keys = [];
    root.querySelectorAll(".rs-main .rs-nav-link[data-rs-page-key],.rs-main .rs-mega-link[data-rs-page-key],.rs-main .rs-drawer-list a[data-rs-page-key],.rs-main .rs-logo[data-rs-page-key]").forEach(function (link) {
