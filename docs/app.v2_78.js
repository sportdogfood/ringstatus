...
const URL_TRIPS    = ['https://ringstatus-proxy.gombcg.workers.dev/docs/8778/schedules/trips.json'];
  const URL_SCHEDULE = ['https://ringstatus-proxy.gombcg.workers.dev/docs/9999/schedules/schedule.json'];
