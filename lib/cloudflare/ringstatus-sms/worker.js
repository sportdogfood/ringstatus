...
const DEFAULT_WATCH_TRIPS_URL =
  "https://raw.githubusercontent.com/sportdogfood/clear-round-datasets/refs/heads/main/docs/schedule/data/latest/watch_trips.json";
...
async function tryRiderLane({ inboundBody, twowayId, phone, env, addDbg, withDbg }) {
  ...
  const matches = records.filter((r) => normalize(r?.riderName) === needle);
