...
const WORKER_VERSION = "ringstatus-sms-result-aliases-2026-04-19";
...
function isCompletedRecord(record) {
  ...
  return status === "completed" || (shouldDisplayFlag(firstText(record?.goneIn, record?.gone_in, record?.rs_gone_in)) && hasDisplayResult(record));
}
