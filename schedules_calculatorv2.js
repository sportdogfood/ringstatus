...
function buildScheduleLogFields(row, groupRow, heartbeatContext, computation, calcStatus, skipReason, scheduleLogFieldSet) {
  const fields = {};
...
async function main() {
  ...
  const [watchScheduleFieldSet, scheduleLogFieldSet] = await Promise.all([
